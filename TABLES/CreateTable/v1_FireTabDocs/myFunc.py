...
def genTableDict(media, uid, betMin, buyIn, rTimeout,
    allowWat, public, adminStart, seats, fTimestamp, game, coinName, invPlayers):
    return {
        u"table": {
            u"isGameFinished":False, u"isGameStarted":False, u"media":media,
            u"admin": uid, u"minBet": betMin,
            u"buyIn":buyIn, u"rTimeout":rTimeout, u"alloWatchers":allowWat,
            u"public": public, u"scheduled": None, u"adminStart": adminStart,
            u"totalSeats": seats, u"status": "lobby", u"openDate": fTimestamp
        },
        u"game": game,
        u"watchers": [],
        u"currency": coinName,
        u"invPlayers": invPlayers, u"players": [uid]
    }